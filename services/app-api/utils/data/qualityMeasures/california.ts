...
export const CA: Programs = {
  "Drug MediCal - Organized Delivery System": [
    {
      measure_name:
  ...
  "Dental Managed Care": [
    ...
    {
      measure_name: "Continuity Of Care",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "Preventive Services To Fillings",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Total Eligibles Receiving a Sealant on a Permanent Molar Tooth (CMS 416 Line 12d)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
    ...
    {
      measure_name: "Usual Source Of Care",
      measure_identifier: measureIdentifiers.neither,
    },
  ],
  "Medi-Cal Managed Care program (MCMC)": [
    {
