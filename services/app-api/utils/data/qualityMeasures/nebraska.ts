...
export const NE: Programs = {
  "Heritage Health": [
    ...
    {
      measure_name: "Frequency Of Selected Procedures (HEDIS FSP)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
    ...
    {
      measure_name: "Language Diversity of Membership (HEDIS LDM)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "Race/Ethnicity Diversity Of Membership (HEDIS RDM)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
