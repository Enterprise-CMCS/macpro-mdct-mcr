...
export const WI: Programs = {
  ...
  "Family Care": [
    ...
    {
      measure_name: "Competitive Integrated Employment",
    ...
    {
      measure_name: "Member Centered Care Planning",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "Social Activities",
      measure_identifier: measureIdentifiers.neither,
    },
  ],
  ...
  "Care 4 Kids": [
    ...
    {
      measure_name: "1.1 Out-Of-Home Care Health Screen",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "1.2 Timely Comprehensive Initial Health Assessment",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "2.1 Timely Enhanced Healthcheck Periodicity",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "2.4 Developmental/ Mental Health Screen",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "4.1 Initial Dental Exam",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "4.2 Ongoing Dental Exams",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "5.1 Developmental Assessment",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "5.2 Mental Health Assessment",
      measure_identifier: measureIdentifiers.neither,
    },
  ],
  "SSI Managed Care (SSI)": [
    {
      measure_name:
        "Adherence To Antipsychotic Medications For Individuals With Schizophrenia (HEDIS SAA)",
      measure_identifier: measureIdentifiers.yes,
  ...
  "Wraparound Milwaukee": [
    {
      measure_name: "Child Behavior Checklist",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "Member Survey",
      measure_identifier: measureIdentifiers.neither,
    },
  ],
};
