...
export const DE: Programs = {
  "Delaware State Health Plan/Delaware State Health Plan Plus": [
    {
      measure_name:
    ...
    {
      measure_name: "Adult Immunization Status (HEDIS AIS)",
      measure_identifier: measureIdentifiers.yes,
    ...
    {
      measure_name: "CAHPS MA PDP - Adult: Care Coordination",
      measure_identifier: measureIdentifiers.yes,
      measure_identifierCmit: "106",
    },
    {
    ...
    {
      measure_name:
        "Depression Remission at 12 Months for Adolescents and Adults (HEDIS DRR)",
      measure_identifier: measureIdentifiers.yes,
      measure_identifierCmit: "190",
    },
    {
      measure_name:
    ...
    {
      measure_name: "HIV Viral Load Suppression",
      measure_identifier: measureIdentifiers.yes,
      measure_identifierCmit: "325",
    },
    {
    ...
    {
      measure_name:
        "Non-Recommended Cervical Cancer Screening In Adolescent Females (HEDIS NCS)",
      measure_identifier: measureIdentifiers.yes,
      measure_identifierCmit: "464",
    },
    {
    ...
    {
      measure_name: "Depression Screening and Follow-Up (HEDIS DSF)",
      measure_identifier: measureIdentifiers.yes,
    ...
    {
      measure_name: "Use Of Imaging Studies For Low Back Pain (HEDIS LBP)",
      measure_identifier: measureIdentifiers.yes,
      measure_identifierCmit: "746",
    },
    {
    ...
    {
      measure_name: "Postpartum Depression Screening And Follow-Up (HEDIS PDS)",
      measure_identifier: measureIdentifiers.yes,
      measure_identifierCmit: "1781",
    },
    {
      measure_name: "Prenatal Immunization Status (HEDIS PRS)",
      measure_identifier: measureIdentifiers.yes,
      measure_identifierCmit: "1782",
    },
    {
      measure_name:
    ...
    {
      measure_name: "30-Day Hospital Readmission Rate",
    ...
    {
      measure_name:
        "Antibiotic Utilization For Respiratory Conditions (HEDIS AXR)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
    ...
    {
      measure_name: "Diagnosed Substance Use Disorders (HEDIS DSU)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
    ...
    {
      measure_name: "Prenatal Depression Screening And Follow-Up (HEDIS PND)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
    ...
    {
      measure_name: "Social Need Screening And Intervention (HEDIS SNS)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
    ...
    {
      measure_name: "Unhealthy Alcohol Use Screening And Follow-Up (HEDIS ASF)",
      measure_identifier: measureIdentifiers.neither,
    },
  ],
};
