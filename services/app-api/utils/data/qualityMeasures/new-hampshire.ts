...
export const NH: Programs = {
  "MCM-Dental Services": [
    ...
    {
      measure_name: "CAHPS Dental - Child: Ease Of Finding A Dentist",
      measure_identifier: measureIdentifiers.neither,
    },
    {
    ...
    {
      measure_name:
        "Dental Service, Equipment And Supply Service Authorization Timely Determination Rate",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
    ...
    {
      measure_name: "Successful Completion Of Dental Risk Assessment",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
  ...
  "Medicaid Care Management (MCM)": [
    ...
    {
      measure_name:
        "Medical Service, Equipment and Supply Service Authorization Timely Determination Rate:  Urgent Requests (average)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Medical Service, Equipment and Supply Service Authorization Timely Determination Rate:  New Routine Requests (average)",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "Members Enrolled In Care Management",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "NEMT Leg Outcome",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "Polypharmacy Monitoring",
      measure_identifier: measureIdentifiers.neither,
    },
    {
    ...
    {
      measure_name: "Timeliness Of Scheduled And Delivered NEMT Legs",
      measure_identifier: measureIdentifiers.neither,
    },
  ],
};
