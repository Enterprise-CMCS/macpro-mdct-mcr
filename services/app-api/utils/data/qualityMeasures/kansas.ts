...
export const KS: Programs = {
  KanCare: [
    ...
    {
      measure_name:
        "Annually Increase Claims For Speech Therapy Via Telehealth",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Annually Increase Claims For Wellness Monitoring Via Telehealth",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Annually Increase Number Billed Claims For Specialists Providing Care Via Telehealth To Frontier, Densely-Settled Rural, And Rural Counties",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Increase Peer Support Utilization For BH Services By 10% Year Over Year",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Increase Percent Of Those Enrolled In Onecare Kansas That Received A Claim For Care Coordination By 10% Year Over Year",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Increase The Number Of Crisis Response Claims That Occur In The Community Setting, Including In The Member's Home",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Increase The Percentage Of Members Who Feel Their Long-Term Services Meet Their Current Needs And Goals To 85% Over The Next Three Years",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Increase The Rate Of Claims That Use Of Z Codes By 1% On Claims Year Over Year To Better Identify Members With Employment, Housing, Legal, Food Or Health Access Needs",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name: "Increase The Rate Of Completed Health Screens",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
        "Increase The Rate Of Members Enrolled Into OCK By 10% Year Over Year",
      measure_identifier: measureIdentifiers.neither,
    },
    {
      measure_name:
    ...
    {
      measure_name:
        "Reduction In Use Of Antipsychotic Medications In Nursing Homes Less Than Or Equal To 12%",
      measure_identifier: measureIdentifiers.neither,
    },
  ],
};
