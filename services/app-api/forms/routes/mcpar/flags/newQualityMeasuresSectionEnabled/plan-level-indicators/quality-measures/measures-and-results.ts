        ...
        props: {
          ...
          hint: [
            ...
            },
            {
              type: "span",
              content:
                "? If measurement varied from CMIT or Consensus Based Entity (CBE) specifications, answer “No, it uses neither CMIT or CBE”. If “No, it has a Consensus Based Entity (CBE) number”, go to D2.VII.2b. If “No, it has a Consensus Based Entity (CBE) number”, go to D2.VII.2c.",
            },
          ],
          choices: [
            {
              ...
              children: [
                {
                  ...
                  props: {
                    label: "D2.VII.2b Consensus Based Entity (CBE) number",
                  },
                },
              ],
            },
              ...
              children: [
                {
                  ...
                  props: {
                    label: "D2.VII.2c How is this measure defined?",
                    hint: "If this measure has neither a CMIT nor CBE number, provide a link to the specification (if available). If not available, provide a measure definition (i.e., describe how the numerator and denominator, as well as exclusion criteria for each, are defined). If this measure has been modified from an existing CMIT or CBE specification, briefly describe the modification.",
                  },
                },
              ],
            },
        ...
        props: {
          ...
          choices: [
            ...
            },
            {
              ...
              label:
                "Plan Report Cards [such as the state’s Medicaid and CHIP Quality Rating System (QRS) (as defined at 42 CFR 438 Subpart G)]",
            },
            {
              id: "9xOPIS3K69pdNdmIWab4RLCV",
              label:
                "Plan Withhold Arrangements (as defined at 42 CFR 438.6(b))",
            },
            {
              id: "lMHlZN8F1teQ5wy6t6a2IDBt",
              label:
                "Plan Incentive Arrangements (as defined at 42 CFR 438.6(b))",
            },
            {
            ...
            },
            {
              ...
              label:
                "In Lieu of Service or Setting (ILOS; as defined at 42 CFR §§ 438.3(e)(2) and 438.16)",
            },
            {
