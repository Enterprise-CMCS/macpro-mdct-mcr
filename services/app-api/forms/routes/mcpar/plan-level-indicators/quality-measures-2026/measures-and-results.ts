          ...
          choices: [
            ...
            },
            {
              ...
              children: [
                ...
                {
                  id: "measure_identifierUrl",
                  type: ReportFormFieldType.TEXT,
                  validation: {
                    type: ValidationType.URL_OPTIONAL,
                    nested: true,
                    parentFieldName: "measure_identifier",
                    parentOptionId: "hcsq9mTy5wWhxUPtgkQWwB",
                  },
                  props: {
                    label: "Link to the measure specification (optional)",
                  },
                },
                {
                  id: "measure_identifierDomain",
                  ...
                  props: {
                    label: "D2.VII.2a Measure domain",
                    hint: "Select one or more measure domains or add your own as needed.",
                    choices: [
                      {
                        id: "3fj5mLIKvGHC8Obt7YnVYp",
                        label: "Primary care access and preventative care",
                      },
                      {
                        id: "03t5xZRG7NlfuH98afQvfh",
                        label: "Maternal and perinatal health",
                      },
                      {
                        id: "ygPYwo4BYtOprLv4yGR0Lc",
                        label: "Care of acute and chronic conditions",
                      },
                      {
                        id: "h02cn7n9OEY70MuEoMjVUp",
                        label: "Behavioral health care",
                      },
                      {
                        id: "tCQ00Yn1NVv5G8u6XSCbab",
                        label: "Dental and oral health services",
                      },
                      {
                        id: "91CSn9m44zCI0CU9tg9Bt9",
                        label: "Experience of care",
                      },
                      {
                        id: "qKriWrOoPseXXnaM88Rqpe",
                        label: "Long-term services and supports",
                      },
                      {
                        id: "obrFjzruEFPxkwkabnf8V2",
                        label: "Other, specify",
                        children: [
                          {
                            id: "measure_identifierDomain-otherText",
                            type: ReportFormFieldType.TEXT,
                            validation: {
                              type: ReportFormFieldType.TEXT,
                              nested: true,
                              parentFieldName: "measure_identifierDomain",
                              parentOptionId: "obrFjzruEFPxkwkabnf8V2",
                            },
                          },
                        ],
                      },
