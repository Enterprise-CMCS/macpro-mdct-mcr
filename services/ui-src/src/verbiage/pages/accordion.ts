      ...
      intro: [
        {
          type: "text",
          as: "span",
          content: "<b>State User Instructions</b><br/><br/>As described at ",
        },
        {
          type: "externalLink",
        ...
        },
        {
          type: "text",
          as: "span",
          content: ". <br/> <br/> <b>CMS Admin Instructions</b>",
        },
      ],
      list: [
      ...
      intro: [
        {
          ...
          as: "span",
          content:
            "<p>States must provide summary MLR report data for each managed care plan. These reports are based on the plans' annual MLR reports to the state under ",
        },
        {
          type: "externalLink",
          content: "42 CFR § 438.8(k)",
