  ...
  cards: {
    ...
    NAAAR: {
      ...
      accordion: {
        ...
        introText:
          "The information is required under 42 CFR § 438.207(d)(3) to be submitted to CMS under 3 scenarios:",
        orderedList: [
          "When a state enters into a contract with each MCO, PIHP, or PAHP;",
          "On an annual basis;",
          "When there is a significant change, as defined by the state, in the operations that would affect the adequacy of capacity and services of an MCO, PIHP, or PAHP.",
        ],
        followUpText:
