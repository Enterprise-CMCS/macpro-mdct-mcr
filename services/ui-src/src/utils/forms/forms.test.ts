...
describe("utils/forms", () => {
  ...
  describe("initializeChoiceListFields()", () => {
  ...
  describe("getEntriesToClear()", () => {
    it("returns ids of entries to clear", () => {
      const result = getEntriesToClear(mockNestedFormField, [
        mockNestedFormField,
      ]);
