...
const cleanStandardNumericalInputTestCases = [
  ...
  { test: "-1234", expected: "-1234" },
  { test: "123%", expected: "123" },
  { test: "123%%", expected: "123%%" }, // invalid input, won't be cleaned
  { test: "--123", expected: "--123" }, // invalid input, won't be cleaned
  { test: "$$123", expected: "$$123" }, // invalid input, won't be cleaned
  { test: "$$1234", expected: "$$1234" },
  { test: "$123", expected: "123" },
  { test: "$1234", expected: "1234" },
  { test: "$$1234567890.10", expected: "$$1234567890.10" }, // invalid input, won't be cleaned
  { test: "$$$$$23453--123081", expected: "$$$$$23453--123081" }, // invalid input, won't be cleaned
  { test: "!@#$%*^()_", expected: "!@#$%*^()_" },
