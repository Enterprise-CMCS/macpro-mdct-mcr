...
describe("plans", () => {
  test("Returns correct data for non-compliant plan (percent of enrollees quarterly)", () => {
  ...
  test("Returns correct data for non-compliant plan (actual max time quarterly)", () => {
    const mockNonCompliantPlan = {
      ...mockPlanData,
      exceptionsNonCompliance: nonComplianceStatus,
      "mock-nonComplianceDescription": "mock description",
      ...
      mock_geomappingComplianceFrequency_EnrolleesMeetingStandard:
        "mock geomapping enrollees meeting standard",
      mock_geomappingComplianceFrequency_q1ActualMaxTime: "mock q1 value",
      mock_geomappingComplianceFrequency_q2ActualMaxTime: "mock q2 value",
      mock_geomappingComplianceFrequency_q3ActualMaxTime: "mock q3 value",
      mock_geomappingComplianceFrequency_q4ActualMaxTime: "mock q4 value",
      // plan provider directory review
      mock_ppdrComplianceFrequency: "mock ppdr compliance frequency",
      mock_ppdrComplianceFrequency_EnrolleesMeetingStandard:
        "mock ppdr enrollees meeting standard",
      ...
      questions: [
        ...
        },
        {
          ...
          answer: [
            "Geomapping",
            "Frequency of compliance findings (optional): mock geomapping compliance frequency: mock geomapping enrollees meeting standard:",
            "Q1 (optional): mock q1 value minutes",
            "Q2 (optional): mock q2 value minutes",
            "Q3 (optional): mock q3 value minutes",
            "Q4 (optional): mock q4 value minutes",
            "Plan Provider Directory Review",
            "Frequency of compliance findings (optional): mock ppdr compliance frequency: mock ppdr enrollees meeting standard:",
            "Annual (optional): mock ppdr annual providers",
            "Date of analysis of annual snapshot (optional): mock ppdr annual providers date",
  ...
  test("Returns correct data for non-compliant plan (actual max distance quarterly)", () => {
    const mockNonCompliantPlan = {
      ...mockPlanData,
      exceptionsNonCompliance: nonComplianceStatus,
      "mock-nonComplianceDescription": "mock description",
      ...
      mock_geomappingComplianceFrequency_EnrolleesMeetingStandard:
        "mock geomapping enrollees meeting standard",
      mock_geomappingComplianceFrequency_q1ActualMaxDist: "mock q1 value",
      mock_geomappingComplianceFrequency_q2ActualMaxDist: "mock q2 value",
      mock_geomappingComplianceFrequency_q3ActualMaxDist: "mock q3 value",
      mock_geomappingComplianceFrequency_q4ActualMaxDist: "mock q4 value",
      // plan provider directory review
      mock_ppdrComplianceFrequency: "mock ppdr compliance frequency",
      mock_ppdrComplianceFrequency_EnrolleesMeetingStandard:
        "mock ppdr enrollees meeting standard",
      ...
      questions: [
        ...
        },
        {
          ...
          answer: [
            "Geomapping",
            "Frequency of compliance findings (optional): mock geomapping compliance frequency: mock geomapping enrollees meeting standard:",
            "Q1 (optional): mock q1 value miles",
            "Q2 (optional): mock q2 value miles",
            "Q3 (optional): mock q3 value miles",
            "Q4 (optional): mock q4 value miles",
            "Plan Provider Directory Review",
            "Frequency of compliance findings (optional): mock ppdr compliance frequency: mock ppdr enrollees meeting standard:",
            "Annual (optional): mock ppdr annual providers",
            "Date of analysis of annual snapshot (optional): mock ppdr annual providers date",
